...
export const funds: Fund[] = [
  {
    ...
    status: "Live",
    returns: { month: 4.5, inception: 24.5 },
    metrics: { liquidityScore: 98, maxDrawdown: -4.2, topConcentration: 45, sharpe: 2.85, nav: 42.85, aum: 53.1 },
    tags: ["Politics", "Macro"],
    holdings: [
  ...
  },
  {
    ...
    status: "Backtest",
    returns: { month: 12.1, inception: 128 },
    metrics: { liquidityScore: 72, maxDrawdown: -12.5, topConcentration: 60 },
    tags: ["AI", "Election"],
    holdings: [
  ...
  },
   {
    ...
    status: "Waitlist",
    returns: { month: 0, inception: 0 },
    metrics: { liquidityScore: 0, maxDrawdown: 0, topConcentration: 0 },
    tags: ["Macro", "Rates"],
    holdings: [
  ...
  },
  {
    ...
    status: "Live",
    returns: { month: 18.2, inception: 89.2 },
    metrics: { liquidityScore: 55, maxDrawdown: -15.8, topConcentration: 55 },
    tags: ["Crypto", "Algo"],
    holdings: [
  ...
  },
  {
    ...
    status: "Live",
    returns: { month: 2.1, inception: 15.4 },
    metrics: { liquidityScore: 90, maxDrawdown: -1.2, topConcentration: 40 },
    tags: ["Sports", "Arb"],
    holdings: [
